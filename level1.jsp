...
<table>
	...
	<td>
		...
		<input type="checkbox" name="c" value="Camera">Camera<br>
		<input type="checkbox" name="c" value="Printer">Printer<br>
		<input type="checkbox" name="c" value="Scanner">Scanner<br>
	</td>	
	</tr>
	<tr>
